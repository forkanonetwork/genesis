...
address=$(cat $ROOT/addresses/payment1.addr)
  ...
  COINS_IN_INPUT=$(echo ${GREATEST_INPUT} | awk '{print $2}')
    ...
    echo "INPUT TXID SELECTION (DEFAULT 0)"
    declare -A txids
    i=0
...
fee="0"
output="0"
#FUNDS FROM STAKE POOLS
#funds=43499999677595

#FUNDS FOR REST OF THE TREASURY
#funds=21499999677595
funds=999998000000
#PROBAR CON ESTE
#funds=22499997677595
